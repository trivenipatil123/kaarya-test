...
class Property(models.Model):
    ...
    long_desc = models.CharField(max_length=2500, blank=True)
    ...
    carper_area = models.CharField(max_length=10, blank=True)
    builtup_area = models.CharField(max_length=10, blank=True)
    super_builtup_area = models.CharField(max_length=10, blank=True)
    no_of_floor = models.IntegerField(default=0)
    floor = models.IntegerField(default=0)
    allowed_for = models.CharField(choices=ALLOWED_FOR, max_length=20, blank=True)
    facing = models.CharField(choices=PROPERTY_FACING, max_length=20, blank=True)
    type_of_ownership = models.CharField(choices=TYPE_OF_OWNERSHIP, max_length=20, blank=True)
    age_of_construction = models.CharField(max_length=50, blank=True)
    builder = models.CharField(max_length=30, blank=True)
    rera_id = models.CharField(max_length=30, blank=True)
    lifts = models.IntegerField(default=0)
    parking = models.BooleanField(default=False)
    property_contact = models.CharField(max_length=10, blank=True)
